...
Feature: Sanity suite (Android)
  ...
  @Sanity
  Scenario: New User Registration (TC-4060)
  ...
  @Sanity
  Scenario: Validate User Sign in & signout happens Successfully (TC-4061,TC-4062)
    When User clicks on "skip" option
    And User clicks on "SigninTabFooter" option
  ...
  @Sanity 
  Scenario: Validate Onboarding users Registration Filters (TC-4061)
  ...
  @Sanity
  Scenario: Validate search filter (TC - 4066)
    When User clicks on "skip" option
