...
public interface FavouriteProperty_OR {
	...
	public By saveAssetButton = By.xpath("//*[@resource-id='com.owners.buyer:id/tv_send']");
	...
	public By captureImageFromCamera = By.id("com.oneplus.camera:id/primary_capture_button");
	public By saveImageAfterClicking = By.id("com.oneplus.camera:id/review_ok_button");
