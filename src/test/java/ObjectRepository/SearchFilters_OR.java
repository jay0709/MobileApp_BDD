...
public interface SearchFilters_OR {
	...
	//public By fourBathFilter = By.xpath("//android.widget.FrameLayout[contains(@resource-id, 'search_result_filter_baths_selection')]//android.widget.LinearLayout//android.widget.TextView[contains(@resource-id,'filter_selection_item_four')]");
	public By priceRangePicker = By.id("com.owners.buyer:id/range_picker_min_text_view");
	public By secondWheelSelector = By.xpath("//android.widget.FrameLayout[2]//android.widget.LinearLayout[1]//android.widget.FrameLayout[contains(@resource-id,'wheel_selector_down')]");
	...
	public By FiltersPageHeader = By.id("com.owners.buyer:id/property_filters_title_text_view");
	public By AppliedFilterText = By.id("com.owners.buyer:id/filter_text");
}
