...
public interface PropertDetailsPage_OR {
	...
	public By imageView = By.xpath("//*[@resource-id=\"com.owners.buyer:id/property_photos_view_pager\"]/android.widget.ImageView[1]");
	public By UserPhotosSection = By.xpath("//*[@text='User Photos']");
	public By UploadedPhoto = By.xpath("//*[@resource-id=\"com.owners.buyer:id/property_photos_view_list\"]/android.widget.FrameLayout[6]");
    ...
    public By EmailErrorText = By.xpath("*//TextInputLayout[1]//android.widget.FrameLayout//android.widget.LinearLayout[1]//android.widget.TextView");
    public By PhoneErrorText = By.xpath("*//TextInputLayout[1]//android.widget.FrameLayout//android.widget.LinearLayout[1]//android.widget.TextView");
