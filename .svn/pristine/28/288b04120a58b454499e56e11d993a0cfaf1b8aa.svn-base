...
public interface Registration_OR {
    ...
    public By onboarding_SignInTabFooter = By.xpath("//android.support.v7.app.ActionBar.Tab[5]//android.widget.LinearLayout");
	...
	public By onboarding_RegnMeBtn = By.xpath("//android.support.v7.app.ActionBar.Tab[5]//android.widget.LinearLayout/android.widget.TextView");
	...
	public By SrpPricehighToLow = By.xpath("//android.widget.FrameLayout[1]/android.widget.FrameLayout[1]/android.widget.ListView[1]/android.widget.LinearLayout[4]/android.widget.RelativeLayout[1]");
	...
	//-----ios locators----//
	/*public By onboarding_SearchBoxDefaultText = By.id("com.owners.buyer:id/onboarding_search_title");
	public By onboarding_SkipLink = By.id("Skip this");
	public By onboarding_SuggestionSearchBox = By.id("com.owners.buyer:id/search_suggestion_search");
	public By onboarding_SearchSuggestion1 = By
			.xpath("//android.widget.FrameLayout[contains(@resource-id,'suggestion_root_view') and @index='0']");
	public By onboarding_SearchSuggestion3 = By
	...
	public By onboarding_PasswordTextBox = By.id("com.owners.buyer:id/account_user_password");
	public By onboarding_SignInBtn = By.xpath("//XCUIElementTypeButton[@name=\"Sign In\"]");
	public By onboarding_SendSurveyBtn = By.id("com.owners.buyer:id/onboarding_survey_send");
	public By onboarding_SurveyPageText = By.xpath("//android.widget.TextView");
	public By onboarding_SurveySkipLink = By.id("com.owners.buyer:id/onboarding_survey_skip");
	public By onboarding_alertTitle = By.id("com.owners.buyer:id/no_result_error");
	...
	public By onboarding_SignInTabFooter = By.id("unselected Favorite");
	public By onboarding_RegisterBtn = By.xpath("//XCUIElementTypeButton[@name=\"Register\"]");
	public By onboarding_RegnFirstName = By.xpath("//XCUIElementTypeApplication[@name=\"Owners.com\"]/XCUIElementTypeWindow[1]/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeScrollView/XCUIElementTypeOther[1]/XCUIElementTypeOther/XCUIElementTypeTextField");
	public By onboarding_RegnLastName = By.xpath("/XCUIElementTypeApplication[@name=\"Owners.com\"]/XCUIElementTypeWindow[1]/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeScrollView/XCUIElementTypeOther[2]/XCUIElementTypeOther/XCUIElementTypeTextField");
	public By onboarding_RegnEmail = By.xpath("//XCUIElementTypeApplication[@name=\"Owners.com\"]/XCUIElementTypeWindow[1]/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeScrollView/XCUIElementTypeOther[3]/XCUIElementTypeOther/XCUIElementTypeTextField");*/
    /*public By onboarding_RegnPassword = By.xpath("//XCUIElementTypeApplication[@name=\"Owners.com\"]/XCUIElementTypeWindow[1]/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeScrollView/XCUIElementTypeOther[4]/XCUIElementTypeOther/XCUIElementTypeSecureTextField");
	public By onboarding_RegnRegisterBtn = By.id("Contact-tab-icon");
	public By onboarding_RegnMeBtn = By
			.id("unselected Favorite");
	public By onboarding_RegnUsrName = By.id("com.owners.buyer:id/account_header_user_name");
	public By onboarding_RegnEmailId = By.id("Account-detail-BG");
	public By onboarding_SignOutLink = By.xpath("//android.widget.TextView[contains(@text,'Sign Out')]");
	public By signOutConfirmMsg = By.id("android:id/message");
	public By signOutCancelBtn = By.id("android:id/button2");
	public By iossignOutOkBtn = By.id("Sign Out");
	public By footerSignInBtn = By.xpath("//android.support.v7.app.ActionBar.Tab[5]");
	public By footerSignInBtnTxt = By.id("Login");
